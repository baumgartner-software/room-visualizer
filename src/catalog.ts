...
export const CATALOG: ElementDef[] = [
  ...
  },
  {
    ...
    name: 'Kochinsel',
    category: 'Küche',
    size: { w: 1.2, h: WORKTOP_HEIGHT, d: 1.2 },
    elevation: 0,
    color: front,
    front: 'pz',
    frontPanels: [2, 2],
  ...
  },
  {
    ...
    name: 'Wasserhahn',
    category: 'Küche',
    size: { w: 0.22, h: 0.32, d: 0.06 },
    elevation: WORKTOP_HEIGHT + WORKTOP_THICKNESS,
    color: black,
    shape: 'faucet',
    description: 'Auslauf zeigt in Richtung der lokalen +X-Achse',
  },
  {
    id: 'box',
    name: 'Freie Box',
